...
const About = () => {
  ...
  const SkillsCard = ({ Title, Skills }) => {
    return (
      <div className="flex flex-col w-full m-[10px] cursor-pointer transition-all duration-150 ease-in-out bg-gradient-to-r  text-gray-900 md:max-w-[400px]  items-center rounded-lg border-[1px] ">
